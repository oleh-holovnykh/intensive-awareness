...
export const Info: React.FC = () => {
  return (
    <div className='text-left break-words max-w-300 w-max mt-2 mx-auto text-gray-600'>
      <div className='mb-2'>
      ...
      <div className='mb-4'>
        ...
        5900 грн <br /> (триразове вегетаріанське. Вартість вказана за весь інтенсив.)
      </div>
      <div>
        <div className='mb-2'>
      ...
      <span className='bg-yellow-100 break-words '> Доплату за інтенсив, а також оплату проживання і харчування <br /> можна будет здати в перший день Інтенсиву - 02 серпня</span>
    </div>
  );
};
